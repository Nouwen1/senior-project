...
$batchnumber = $conn->real_escape_string($_POST['batchnumber']);
$expirydate = $conn->real_escape_string($_POST['expirydate']);
$quantity = $conn->real_escape_string($_POST['quantity']);
$manufacturingdate = $conn->real_escape_string($_POST['manufacturingdate']);
...
$query = "INSERT INTO medicines(productname,batchnumber,expirydate,quantity,manufacturingdate) VALUES('" . $productname . "','" . $batchnumber . "','" . $expirydate . "','" . $quantity . "','" . $manufacturingdate . "')";
...
if (!$success){
  ...
  <script type="text/javascript" src="js/bootstrap.min.js"></script>
    ...
    <div class="jumbotron">
     <h1>Oops...!!! </h1>
     <p>Kindly enter the facility details</p>
     <p><a href="add_facility.php"> Click Me </a></p>
