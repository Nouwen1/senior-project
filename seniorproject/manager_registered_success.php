<html>
  ...
  <head>
    <title> Manager registered | Afya </title>
  </head>
...
$query = "INSERT into manager(username,name,email,contact,address,password) VALUES('" . $username . "','" . $name . "','" . $email . "','" . $contact . "','" . $address ."','" . $password ."')";
