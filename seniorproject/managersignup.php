<html>
  ...
  <head>
    <title> Manager Signup | Afya </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Manager, <br> Welcome to <span class="edit"> Afya </span></h1>
     <br>
        ...
        <form role="form" action="manager_registered_success.php" method="POST">
          ...
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="name" type="text" name="name" placeholder="Your Full Name" required="" autofocus="">
